                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('all_parties', $type) }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All Parties</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('create_party', $type) }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create Party</p>
                                    </a>
                                </li>
                        ...
                        @if ($type === 'superAdmin')
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('all_admins', $type) }}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>All Admins</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('create_admin', $type) }}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Create Admin</p>
                                        </a>
                                    </li>
